        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('item_card_categories.create') }}" class="btn btn-sm btn-success">اضافة جديد</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($data as $info)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('item_card_categories.edit', $info->id) }}"
                                                    class="btn btn-sm btn-primary">تعديل</a>
                                                    <form class="d-inline" action="{{route('item_card_categories.destroy',$info->id)}}" method="POST">
                                                        @csrf
                                                        @method('delete')
